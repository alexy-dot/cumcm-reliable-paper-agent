...
- For repeated/grouped numeric observations, that routing reference also explains the optional `grouped_regression.py` helper for fair baselines and nested group validation; it does not infer causal effects or the grouping unit.
